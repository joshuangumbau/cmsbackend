            ...
            <div class="col-md-12 col-md-offset-0 col-lg-8 col-lg-offset-1" style="margin-bottom:20px">
                <div class="panel rounded-top" style="background-color: #e8ddd3;">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center">Mark Attendance for <strong>{{ \Auth::user()->branchname }}
                                            ...
                                            <tr class="<?php echo $class[$num]; ?>" id="row,{{ $count }}">
                                                ...
                                                <td>
                                                    <div id="" class="input-group">
                                                        <div class="checkbox">
                                                            <label><input name="atte" type="checkbox">Present<input
                                                                    id="" type="hidden" value="no"
                                                                    name="attendance[]" class="" /></label>
                                                        </div>
                                                    </div>
                                                </td>
                                                <input id="" type="hidden" value="{{ $member->id }}"
                                                    name="member_id[]" class="" />
                                            </tr>
                                            <?php $count++; ?>
                                        @endforeach
                                ...
                                <div class="row">
                                    <div class="col-md-3" style="width:30%;">
                                        ...
                                        <input
                                            ...
                                            type="text" placeholder="Choose Date" name="date"
                                            class="datepicker form-control" required />
                                    </div>

                                    <div class="form-group col-md-3">
                                        <h3><label for="date">Choose Service Type</label></h3>
                                        <select style="outline:none" name="type" class="selectpicker col-md-12"
                                            data-style="btn-info">
                                            @foreach ($services as $service)
                                                <option value="{{ $service->id }}">{{ $service->name }}</option>
                                            @endforeach
