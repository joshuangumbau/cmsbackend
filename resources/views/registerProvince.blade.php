    ...
    <div id="container" class="effect aside-float aside-bright mainnav-lg">
                    ...
                    <ul class="nav navbar-top-links">
                                ...
                                <div class="row">
                                    <div class="col-sm-4 col-md-3">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li><a href="forms-general.html#" class="disabled">Disabled</a></li>
                                        </ul>
                                    ...
                                    <div class="col-sm-4 col-md-3">
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="dropdown-header"><i class="demo-pli-mail icon-lg icon-fw"></i>
                                                Mailbox</li>
                                            <li><a href="forms-general.html#"><span
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        ...
                                        <a href="forms-general.html#" class="btn btn-block btn-primary">Browse
                                            Gallery</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                                <div class="nano scrollable">
                                    <div class="nano-content">
                                        <ul class="head-list">
                                            <li>
                                                <a href="forms-general.html#" class="media add-tooltip"
                        ...
                        <li id="dropdown-user" class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                                <ul class="head-list">
                                    <li>
                                        <a href="forms-general.html#"><i class="demo-pli-male icon-lg icon-fw"></i>
                                            Profile</a>
                                    </li>
                                    <li>
                                        <a href="forms-general.html#"><span
                                                class="badge badge-danger pull-right">9</span><i
                                    ...
                                    <li>
                                        <a href="forms-general.html#"><i
                                                class="demo-pli-computer-secure icon-lg icon-fw"></i> Lock screen</a>
                                    </li>
                                    <li>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-inline">
                                <div class="form-group">
                                    ...
                                    <input type="email" placeholder="Enter email" id="demo-inline-inputmail"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="demo-inline-inputpass" class="sr-only">Password</label>
                                    <input type="password" placeholder="Password" id="demo-inline-inputpass"
                                        class="form-control">
                                </div>
                                <div class="checkbox">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label"
                                                for="demo-hor-inputemail">Email</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label"
                                                for="demo-hor-inputpass">Password</label>
                                            <div class="col-sm-9">
                        ...
                        <div class="col-lg-6">
                            <div class="panel">
                                ...
                                <form class="form-horizontal">
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" for="demo-is-inputsmall">Small
                                                Input</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="demo-is-inputnormal" class="col-sm-3 control-label">Normal
                                                Input</label>
                                            <div class="col-sm-6">
                                                <input type="text" placeholder="Normal" class="form-control"
                                                    id="demo-is-inputnormal">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="demo-is-inputlarge" class="col-sm-3 control-label">Large
                                                Input</label>
                                            <div class="col-sm-6">
                                                <input type="text" placeholder=".input-lg"
                                                    class="form-control input-lg" id="demo-is-inputlarge">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="panel-body">
                                        <div class="input-group mar-btm">
                                            <div class="input-group-addon">
                                                <input id="demo-checkbox-addons" class="magic-checkbox"
                                                    type="checkbox">
                                        ...
                                        <div class="input-group mar-btm">
                                            <span class="input-group-addon">
                                                <input id="demo-radio-addons" class="magic-radio" type="radio"
                                                    name="input-group-radio" checked>
                                        ...
                                        <div class="input-group mar-btm">
                                            <span class="input-group-addon">
                                                <input id="demo-radio-addons-2" class="magic-radio" type="radio"
                            ...
                            <div class="panel">
                                ...
                                <form class="form-horizontal">
                                    <div class="panel-body">
                                        ...
                                        <div class="input-group mar-btm">
                                            <span class="input-group-btn">
                                                <button class="btn btn-mint" type="button"><i
                                                        class="demo-pli-like"></i></button>
                                            </span>
                                            <input type="text" placeholder="Comment" class="form-control">
                                            <span class="input-group-btn">
                                                <button class="btn btn-mint" type="button"><i
                                                        class="demo-pli-unlike"></i></button>
                                            </span>
                                        </div>
                                    </div>
                                </form>
                        ...
                        <div class="col-lg-6">
                            <div class="panel">
                                ...
                                <form class="panel-body form-horizontal form-padding">
                                    ...
                                    <!--Email Input-->
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="demo-email-input">Email
                                            Input</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label"
                                            for="demo-password-input">Password</label>
                                        <div class="col-md-9">
                                            <input type="password" id="demo-password-input" class="form-control"
                                    ...
                                    <!--Readonly Input-->
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="demo-readonly-input">Readonly
                                            input</label>
                                        <div class="col-md-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label"
                                            for="demo-textarea-input">Textarea</label>
                                        <div class="col-md-9">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="radio">
                                                <input id="demo-form-radio" class="magic-radio" type="radio"
                                                    name="form-radio-button" checked>
                                    ...
                                    <div class="form-group pad-ver">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="checkbox">
                                                <input id="demo-form-checkbox-2" class="magic-checkbox"
                                                    type="checkbox">
                                                <label for="demo-form-checkbox-2">Option 2</label>
                                            </div>

                                            <div class="checkbox">
                                                <input id="demo-form-checkbox-3" class="magic-checkbox"
                                                    type="checkbox">
                                    ...
                                    <div class="form-group pad-ver">
                                        ...
                                        <div class="col-md-9">
                                            <div class="checkbox">
                                                ...
                                                <input id="demo-form-inline-checkbox-2" class="magic-checkbox"
                                                    type="checkbox">
                                                <label for="demo-form-inline-checkbox-2">Option 2</label>

                                                <input id="demo-form-inline-checkbox-3" class="magic-checkbox"
                                                    type="checkbox">
                            ...
                            <div class="panel">
                                ...
                                <form class="panel-body form-horizontal form-padding">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control"
                                                placeholder="Readonly input here..." readonly disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group pad-ver">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="radio">
                                                <input id="demo-disabled-form-radio" class="magic-radio"
                                                    type="radio" name="disabled-form-radio-button" checked disabled>
                                                <label for="demo-disabled-form-radio">Option 1 (pre-checked)</label>
                                            </div>
                                            <div class="radio">
                                                <input id="demo-disabled-form-radio-2" class="magic-radio"
                                                    type="radio" name="disabled-form-radio-button" disabled>
                                                <label for="demo-disabled-form-radio-2">Option 2</label>
                                            </div>
                                            <div class="radio">
                                                <input id="demo-disabled-form-radio-3" class="magic-radio"
                                                    type="radio" name="disabled-form-radio-button" disabled>
                                    ...
                                    <div class="form-group pad-ver">
                                        ...
                                        <div class="col-md-9">
                                            <div class="radio">
                                                ...
                                                <!-- Inline radio buttons -->
                                                <input id="demo-disabled-inline-form-radio" class="magic-radio"
                                                    type="radio" name="disabled-inline-form-radio" checked disabled>
                                                <label for="demo-disabled-inline-form-radio">Option 1
                                                    (pre-checked)</label>

                                                <input id="demo-disabled-inline-form-radio-2" class="magic-radio"
                                                    type="radio" name="disabled-inline-form-radio" disabled>
                                                <label for="demo-disabled-inline-form-radio-2">Option 2</label>

                                                <input id="demo-disabled-inline-form-radio-3" class="magic-radio"
                                                    type="radio" name="disabled-inline-form-radio" disabled>
                                    ...
                                    <div class="form-group pad-ver">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="checkbox">
                                                <input id="demo-disabled-form-checkbox" class="magic-checkbox"
                                                    type="checkbox" checked disabled>
                                                <label for="demo-disabled-form-checkbox">Option 1 (pre-checked)</label>
                                            </div>

                                            <div class="checkbox">
                                                <input id="demo-disabled-form-checkbox-2" class="magic-checkbox"
                                                    type="checkbox" disabled>
                                                <label for="demo-disabled-form-checkbox-2">Option 2</label>
                                            </div>

                                            <div class="checkbox">
                                                <input id="demo-disabled-form-checkbox-3" class="magic-checkbox"
                                                    type="checkbox" disabled>
                                    ...
                                    <div class="form-group pad-ver">
                                        ...
                                        <div class="col-md-9">
                                            <div class="checkbox">
                                                ...
                                                <!-- Inline Checkboxes -->
                                                <input id="demo-disabled-form-inline-checkbox" class="magic-checkbox"
                                                    type="checkbox" checked disabled>
                                                <label for="demo-disabled-form-inline-checkbox">Option 1
                                                    (pre-checked)</label>

                                                <input id="demo-disabled-form-inline-checkbox-2"
                                                    class="magic-checkbox" type="checkbox" disabled>
                                                <label for="demo-disabled-form-inline-checkbox-2">Option 2</label>

                                                <input id="demo-disabled-form-inline-checkbox-3"
                                                    class="magic-checkbox" type="checkbox" disabled>
                                    ...
                                    <div class="pad-hor">
                                        <p>Lorem ipsum dolor sit amet, consectetuer
                                            <a data-title="45%" class="add-tooltip text-semibold text-main"
                                                href="forms-general.html#">adipiscing elit</a>, sed diam nonummy nibh.
                            ...
                            <div class="nano-content">
                                ...
                                <div id="mainnav-profile" class="mainnav-profile">
                                    <div class="profile-wrap text-center">
                                        ...
                                        <a href="forms-general.html#profile-nav" class="box-block"
                                ...
                                <ul id="mainnav-menu" class="list-group">
                                    ...
                                    <li>
                                        ...
                                        <ul class="collapse">
                                            ...
                                            <li><a href="layouts-aside-right-side.html">Aside on the right side</a>
                                            </li>
                                ...
                                <div class="mainnav-widget">
                                    ...
                                    <div class="show-small">
                                        <a href="forms-general.html#" data-toggle="menu-widget"
                                    ...
                                    <div id="demo-wg-server" class="hide-small mainnav-widget-content">
                                        <ul class="list-group">
                                            ...
                                            <li class="pad-ver"><a href="forms-general.html#"
                                                    class="btn btn-success btn-bock">View Details</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <!--================================-->
        ...
        <footer id="footer">
            ...
            <div class="show-fixed pad-rgt pull-right">
                You have <a href="forms-general.html#" class="text-main"><span class="badge badge-danger">3</span>
                    pending action.</a>
            </div>
